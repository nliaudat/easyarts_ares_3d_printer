...
#define STRING_CONFIG_H_AUTHOR "(adamfalwell, default config)" // Who made the changes.
...
#define MACHINE_UUID "1d05046d-fc16-46e1-8cfe-d4b295d9f7da"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
  #define DEFAULT_bedKp 125.11
  #define DEFAULT_bedKi 22.79
  #define DEFAULT_bedKd 457.76
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 220.2        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 198.75             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.81, -0.04, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 113.69              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.49, -0.77, 0.28 } // Get these values from G33 auto calibrate
...
#define Z_PROBE_SPEED_FAST 1600
...
#define MANUAL_Z_HOME_POS 205 // Distance between the nozzle to printbed after homing
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 80  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 80  // Y point for Z homing
#endif
