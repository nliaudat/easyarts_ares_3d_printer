...
// M211  easyarts bed_level_compensation_factor  between 300--800//easyartws
...
float bed_level_compensation_factor=450;//easyarts
...
static void engage_z_probe() {
    ...
    destination[Y_AXIS] = 60;//72 easyarts
    destination[Z_AXIS] = 50;//60;//100 easyarts same with Z_RAISE_BEFORE_PROBING
    prepare_move_raw();
...
static void retract_z_probe() {
	...
	//easyarts ares don't need this action
    /*feedrate = homing_feedrate[X_AXIS];
...
void process_commands()
{
    ...
    case 29: // G29 Detailed Z-Probe, probes the bed at 3 or more points.
        {
            ...
            #ifdef NONLINEAR_BED_LEVELING
            float z_offset= Z_PROBE_OFFSET_FROM_EXTRUDER; //easyarts
            ...
            for (int yCount=0; yCount < ACCURATE_BED_LEVELING_POINTS; yCount++)
            {
              ...
              for (int xCount=xStart; xCount != xStop; xCount += xInc)
              {
                ...
                #ifdef NONLINEAR_BED_LEVELING
                bed_level[xCount][yCount] = measured_z+ z_offset +(distance_from_center/bed_level_compensation_factor);//easyarts +distance_from_center/500 calibration for easyarts autobedlevel method
                #endif //NONLINEAR_BED_LEVELING
  ...
  else if(code_seen('M'))
  {
	...
	///////////////////////////////////////////////////////easyarts	
	case 211://M211  easyarts bed_level_compensation_factor  between 300--800
	{
	  if(code_seen('S'))
	  {
		float factor_value = code_value(); 
		if(factor_value>=3&&factor_value<=800)
		  bed_level_compensation_factor= factor_value;
	  }
	}break;
	///////////////////////////////////////////////////////easyarts
